        ...
        try {
          ...
          writeFileSync(path.join(room, 'README.md'),
            [
              ...
              '',
              '  GET  /api/core/routes    -> every Core route, method and path',
              '',
              'Read that first when you need an endpoint you do not already know.',
              'Probing for paths and reading the 404s is what makes a question take',
